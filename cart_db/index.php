        ...
        <div class="cart">
            <table class="cart_table">
                ...
                <?php 
                    ...
                    $resultCheck = $conn->query('SELECT count(*) FROM cart')->fetchColumn();
                    ...
                    if($resultCheck > 0){
                        while($row = $result->fetch(PDO::FETCH_ASSOC)){
                            ...
                            <tr>
                                ...
                                <td><img src="<?php echo $row['img']; ?>" width="100" height="100" alt=""></td>
                                <td><?php echo $row['product_name']; ?></td>
                                <td><?php echo $row['code']; ?></td>
                                <td><?php echo $row['quantity'];?></td>
                                <td><?php echo $row['price']; ?></td>
                                <td><?php printf ("%.2f", $row['quantity'] * $row['price']); ?></td>
                                <td>
                                    <form action="<?php $_SERVER['PHP_SELF']; ?>" method="POST">
                                        <input type="hidden" name="form_delete_id" value="<?php echo $row['id']; ?>">
                                        <input type="submit" name="form_delete_indivisual_item" value="-">
                                    </form>
                                </td>
                            </tr>
                        <?php
